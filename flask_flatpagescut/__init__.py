...
class Page(object):
    ...
    """
    def __init__(self, path, meta_yaml, content, html_renderer):
        """
        Initialize Page instance.

        :param path: Page path.
        :param meta_yaml: Page meta data in YAML format.
        :param cut: Page preview.
    ...
    def cut(self):
        """The preview content of the page, rendered as HTML by the configured
        renderer.
        """
        return self.html_renderer(self.preview)
